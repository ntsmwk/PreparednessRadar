...
public class RemoveGeometryEvolveCommand extends Command {

    private List<GeoJsonFeature> addList, removeList;

    public RemoveGeometryEvolveCommand(GeoJsonLayer geoJsonLayer, List<GeoJsonFeature> addList, List<GeoJsonFeature> removeList) {
        super(geoJsonLayer);
